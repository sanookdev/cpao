...
class AdminSettingSlideImage extends MY_Controller
{
	private $setting_name = "slideimage";
	...
	public function slideimage()
	{
		...
		$data['post'] = 'AdminSettingSlideImage';
		$data['page'] = 'รูปสไลค์';
		return $this->load->view('admin_setting_slide', $data);
	}
