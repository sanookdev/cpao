				...
				<div class="modal-body" style="padding-top: 0px;">
					<form id="save-form" action="<?= base_url() ?>AdminUpload/fileUpload" method="post" class="smart-form">
						...
						<fieldset>
							<div class="row">
								<section class="ph-2">
									<label class="label"><?= (strstr($page, 'รูป') ? '' : 'รูป').$page.' '.(isset($image_suggeest) ? $image_suggeest : '') ?></label>
							...
							<div class="row">
								<section class="ph-2 field-text">
									...
									<label class="input"> <i class="icon-prepend fas fa-fw fa-link"></i>
										<input type="text" maxlength="200" id="setting_value2" name="setting_value2" placeholder="eg. www...">
				...
				"columns": [{
...

					{
						...
						"render": function(data, type, full, meta) {
							...
							${full.setting_value3 || '<code>(ไม่มีชื่อ)</code>'} <a target="_blank" href="${full.setting_value2}">${full.setting_value2}</a>`
						}
					},
