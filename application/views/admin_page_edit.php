...
<head>
  ...
  <link href="<?= base_url("/assets/jsTree/dist/themes/default/style.min.css") ?>" rel="stylesheet" type="text/css">
...
<body class="smart-style-2 fixed-header">
              ...
              <div>
                ...
                <div class="widget-body">
                  <form id="save-form" method="post" class="smart-form">
                    <input type="hidden" id="page_id" value="<?= $item['page_id'] ?>" name="page_id">
                    <fieldset>
                      <div class="row">
                        <section class="col col-6">
                          <label class="label">หัวข้อหน้า *</label>
                          <label class="input"> <i class="icon-prepend fa fa-cube"></i>
                            <input type="text" value="<?= $item['page_title'] ?>" id="page_title" name="page_title" placeholder="">
                        ...
                        <section class="col col-2">
                          ...
                          <label class="checkbox"><input <?= $item['is_show'] == '1' ? 'checked' : '' ?> type="checkbox" value="1" name="is_show" id="is_show"><i></i></label>
                        </section>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        <section class="col col-6 field-link">
                          ...
                          <label class="input"> <i class="icon-prepend fa fa-cube"></i>
                            <input type="text" value="<?= $item['page_type'] == 'link' ? $item['page_detail'] : '' ?>" id="link" name="link" placeholder="eg  http://www...">
                      ...
                      <div class="row field-custom">
                        <div class="ph-2 mb-1">
                          ...
                          <div class="summernote"><?= $item['page_detail'] ?></div>
                        </div>
                      </div>
                    </fieldset>
                    <footer>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $.get('<?= base_url() ?>AdminManagePage/load_submenu?id=' + $('#parent_id').val(), function(data) {
        if (data.length == 0) {
      ...
      $('#jstree')
        .on('loaded.jstree', function() {
          ...
          $('#jstree').jstree('select_node', initPath);
