...
class AdminSettingImportantLink extends MY_Controller
{
	private $setting_name = "important_link";
	...
	public function important()
	{
		...
		$data['post'] = 'AdminSettingImportantLink';
		$data['page'] = 'ลิงค์ที่น่าสนใจ';
		return $this->load->view('admin_setting_important_link', $data);
	}
