...
<?php
$main_page = "รายงาน";
$page = "รายงานการส่งอีเมลและรับอีเมล";
?>
			...
			<section id="widget-grid" class="">
				...
				<div class="row">
					...
					<article class="col-xs-12 col-lg-6">
						...
						<div class="jarviswidget jarviswidget-color-darken" id="wid-id-history-1" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-colorbutton="false" data-widget-editbutton="false">
							<header>
								<span class="widget-icon"> <i class="far fa-fw fa-envelope"></i> </span>
								<h2>รายงานการรับอีเมล์ </h2>
					...
					<article class="col-xs-12 col-lg-6">
						...
						<!-- Widget ID (each widget will need unique ID)-->
						<div class="jarviswidget jarviswidget-color-darken" id="wid-id-history-2" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-colorbutton="false" data-widget-editbutton="false">
							<header>
								<span class="widget-icon"> <i class="fa fa-table"></i> </span>
								<h2>รายงานการส่งอีเมล์</h2>
	...
	<script>
		...
		$(document).ready(function() {
			...
			var tableSent = $('#table-sent').DataTable({
				...
				"preDrawCallback": function() {
					...
					if (!responsiveHelper_dt_sent) {
						responsiveHelper_dt_sent = new ResponsiveDatatablesHelper($(this), breakpointDefinition);
					}
				},
			...
			var loadData = function() {
				...
				$.get('<?= base_url() ?>AdminMail/histories', function(data) {
					const {
						sents,
						receives
					} = data
					if (table) {
						table.clear().draw();
						table.rows.add(receives); // Add new data
