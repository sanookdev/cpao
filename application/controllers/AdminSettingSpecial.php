...
class AdminSettingSpecial extends MY_Controller
{
	private $setting_name = "special";
	...
	public function index()
	{
		...
		$data['post'] = 'AdminSettingSpecial';
		$data['page'] = 'เหตุการณ์พิเศษ';
		return $this->load->view('admin_setting_special', $data);
	}
	...
	public function load_list()
	{
		...
		$list = $this->Setting_Model->getByAndOrder('setting_name', $this->setting_name, 'setting_value4');
	...
	public function save()
	{
		...
		if (isset($data['setting_value3'])){
			$date = $data['setting_value3'];
			$date= str_replace('/', '-', $date);
			$data['setting_value3'] = date('Y-m-d', strtotime($date));
		}
		// check upload file
	...
	public function setting()
	{
		...
		$data['setting_value3'] = date("d/m/Y", strtotime($data['setting_value3']));
