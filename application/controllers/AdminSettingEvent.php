...
class AdminSettingEvent extends MY_Controller
{
	private $setting_name = "event";
	...
	public function event()
	{
		...
		$data['post'] = 'AdminSettingEvent';
		$data['page'] = 'โฆษณาประกาศ';
		return $this->load->view('admin_setting_event', $data);
	}
